...
// Upgrade NOTE: replaced 'mul(UNITY_MATRIX_MVP,*)' with 'UnityObjectToClipPos(*)'
    ...
    Properties {
		...
		_OUTER_RADIUS("Outer Radius", Float) = 1.025
		_INNER_RADIUS("Inner Radius", Float) = 1.0
		_BIAS("Height Bias", Float) = 0.0
	}
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform half _HdrExposure,_RL,_MIE,_SUN, _BIAS;        // HDR exposure
            uniform half3 _GroundColor;
			uniform half _OUTER_RADIUS, _INNER_RADIUS;
            ...
            #define OUTER_RADIUS _OUTER_RADIUS	//1.025
            static const float kOuterRadius = OUTER_RADIUS;
            static const float kOuterRadius2 = OUTER_RADIUS*OUTER_RADIUS;
			static const float kInnerRadius = _INNER_RADIUS; //1.0;
			static const float kInnerRadius2 = _INNER_RADIUS*_INNER_RADIUS;	 //1.0;
